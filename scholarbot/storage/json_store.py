...
def save_session(session_id: str, state: dict) -> bool:
    ...
    Saves: messages, topics_discussed, msg_count, personality, user_name, session_start, uploaded_docs, doc_chunks, quiz_scores.
    ...
    try:
        ...
        # Convert doc_chunks (which may be Chunk dataclasses) to JSON-serializable dicts
        serializable_chunks = []
        ...
        payload = {
            ...
            "doc_chunks": serializable_chunks,
...
def load_session(session_id: str) -> Optional[dict]:
    ...
    try:
        ...
        # Convert doc_chunks dicts back to Chunk objects
        try:
